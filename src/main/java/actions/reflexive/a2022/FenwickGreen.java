...
public class FenwickGreen extends ActionReflexiveAbstract {

    public FenwickGreen(ActionFileBinder actionFileBinder) {
    ...
    public void execute() {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                executeSubActions(ActionFileBinder.ActionFile.A2022_FENWICK_ASCENSEUR_HAUTEUR_PILE_2.ordinal());
                // wait to suck
                try {
                    Thread.sleep(250);
