    ...
    protected void parseActions() {
        ...
        try {
            ...
            if (this.actions.isEmpty()) {
                logger.error("Le fichier "+filename+" doit contenir un objet avec un attribut 'actions' qui est une liste non vide d'énumération de la classe ActionFileBinder à exécuter l'une après l'autre");
            }
