...
public class MainPmi2021 {
    ...
    public static void main(String... arg) throws Exception {
        ...
        recuperationBouees1_2.add(new Manipulation("Preparer ramassage bouée 1", ActionFileBinder.ActionFile.A2020_PMI_SORTIR_LEVER_BRAS_DROIT.ordinal(), Tache.Mirror.SPECIFIC));
        recuperationBouees1_2_3000.add(new Manipulation("Preparer ramassage bouée 1", ActionFileBinder.ActionFile.A2020_PMI_SORTIR_LEVER_BRAS_GAUCHE.ordinal(), Tache.Mirror.SPECIFIC), mirrorId);
        recuperationBouees1_2.add(new GoTo("Mise en position récupération bouée 1", 516, 240));
        mirrorId = recuperationBouees1_2.size() + 1;
        recuperationBouees1_2.add(new Manipulation("Ramassage bouée 1 - Pompe", ActionFileBinder.ActionFile.A2020_PMI_ATTRAPER_BRAS_DROIT.ordinal(), Tache.Mirror.SPECIFIC));
        recuperationBouees1_2_3000.add(new Manipulation("Ramassage bouée 1 - Pompe", ActionFileBinder.ActionFile.A2020_PMI_ATTRAPER_BRAS_GAUCHE.ordinal(), Tache.Mirror.SPECIFIC), mirrorId);
        mirrorId = recuperationBouees1_2.size() + 1;
        recuperationBouees1_2.add(new Manipulation("Ramassage bouée 1 - Poser", ActionFileBinder.ActionFile.A2020_PMI_POSER_BRAS_DROIT.ordinal(), Tache.Mirror.SPECIFIC));
        recuperationBouees1_2_3000.add(new Manipulation("Ramassage bouée 1 - Poser", ActionFileBinder.ActionFile.A2020_PMI_POSER_BRAS_GAUCHE.ordinal(), Tache.Mirror.SPECIFIC), mirrorId);
        mirrorId = recuperationBouees1_2.size() + 1;
        recuperationBouees1_2.add(new Manipulation("Ramassage bouée 1 - Lever", ActionFileBinder.ActionFile.A2020_PMI_SORTIR_LEVER_BRAS_DROIT.ordinal(), Tache.Mirror.SPECIFIC));
        recuperationBouees1_2_3000.add(new Manipulation("Ramassage bouée 1 - Lever", ActionFileBinder.ActionFile.A2020_PMI_SORTIR_LEVER_BRAS_GAUCHE.ordinal(), Tache.Mirror.SPECIFIC), mirrorId);
        ...
        mirrorId = recuperationBouees1_2.size() + 1;
        recuperationBouees1_2.add(new Manipulation("Preparer ramassage bouée 2", ActionFileBinder.ActionFile.A2020_PMI_SORTIR_LEVER_BRAS_GAUCHE.ordinal(), Tache.Mirror.SPECIFIC));
        recuperationBouees1_2_3000.add(new Manipulation("Preparer ramassage bouée 2", ActionFileBinder.ActionFile.A2020_PMI_SORTIR_LEVER_BRAS_DROIT.ordinal(), Tache.Mirror.SPECIFIC), mirrorId);
        recuperationBouees1_2.add(new GoTo("Mise en position récupération bouée 2", 1084, 240));
        mirrorId = recuperationBouees1_2.size() + 1;
        recuperationBouees1_2.add(new Manipulation("Ramassage bouée 2 - Pompe", ActionFileBinder.ActionFile.A2020_PMI_ATTRAPER_BRAS_GAUCHE.ordinal(), Tache.Mirror.SPECIFIC));
        recuperationBouees1_2_3000.add(new Manipulation("Ramassage bouée 2 - Pompe", ActionFileBinder.ActionFile.A2020_PMI_ATTRAPER_BRAS_DROIT.ordinal(), Tache.Mirror.SPECIFIC), mirrorId);
        mirrorId = recuperationBouees1_2.size() + 1;
        recuperationBouees1_2.add(new Manipulation("Ramassage bouée 2 - Poser", ActionFileBinder.ActionFile.A2020_PMI_POSER_BRAS_GAUCHE.ordinal(), Tache.Mirror.SPECIFIC));
        recuperationBouees1_2_3000.add(new Manipulation("Ramassage bouée 2 - Poser", ActionFileBinder.ActionFile.A2020_PMI_POSER_BRAS_DROIT.ordinal(), Tache.Mirror.SPECIFIC), mirrorId);
        mirrorId = recuperationBouees1_2.size() + 1;
        recuperationBouees1_2.add(new Manipulation("Ramassage bouée 2 - Lever", ActionFileBinder.ActionFile.A2020_PMI_SORTIR_LEVER_BRAS_GAUCHE.ordinal(), Tache.Mirror.SPECIFIC));
        recuperationBouees1_2_3000.add(new Manipulation("Ramassage bouée 2 - Lever", ActionFileBinder.ActionFile.A2020_PMI_SORTIR_LEVER_BRAS_DROIT.ordinal(), Tache.Mirror.SPECIFIC), mirrorId);
        recuperationBouees1_2.add(new GoToBack("Mise en position largage bouée 1", 970, 240));
        mirrorId = recuperationBouees1_2.size() + 1;
        recuperationBouees1_2.add(new Manipulation("Largage bouée 1 - Pompe", ActionFileBinder.ActionFile.A2020_PMI_LACHER_BRAS_DROIT.ordinal(), Tache.Mirror.SPECIFIC));
        recuperationBouees1_2_3000.add(new Manipulation("Largage bouée 1 - Pompe", ActionFileBinder.ActionFile.A2020_PMI_LACHER_BRAS_GAUCHE.ordinal(), Tache.Mirror.SPECIFIC), mirrorId);
        ...
        mirrorId = recuperationBouees1_2.size() + 1;
        recuperationBouees1_2.add(new Manipulation("Largage bouée 2 - Pompe", ActionFileBinder.ActionFile.A2020_PMI_LACHER_BRAS_GAUCHE.ordinal(), Tache.Mirror.SPECIFIC));
        recuperationBouees1_2_3000.add(new Manipulation("Largage bouée 2 - Pompe", ActionFileBinder.ActionFile.A2020_PMI_LACHER_BRAS_DROIT.ordinal(), Tache.Mirror.SPECIFIC), mirrorId);
        ...
        recuperationBouees3.add(new Manipulation("Ramassage bouée 5 - Pompe", ActionFileBinder.ActionFile.A2020_PMI_ATTRAPER_BRAS_GAUCHE.ordinal(), Tache.Mirror.SPECIFIC));
        recuperationBouees3_3000.add(new Manipulation("Ramassage bouée 5 - Pompe", ActionFileBinder.ActionFile.A2020_PMI_ATTRAPER_BRAS_DROIT.ordinal(), Tache.Mirror.SPECIFIC), mirrorId);
        mirrorId = recuperationBouees3.size() + 1;
        recuperationBouees3.add(new Manipulation("Ramassage bouée 5 - Poser", ActionFileBinder.ActionFile.A2020_PMI_POSER_BRAS_GAUCHE.ordinal(), Tache.Mirror.SPECIFIC));
        recuperationBouees3_3000.add(new Manipulation("Ramassage bouée 5 - Poser", ActionFileBinder.ActionFile.A2020_PMI_POSER_BRAS_DROIT.ordinal(), Tache.Mirror.SPECIFIC), mirrorId);
        mirrorId = recuperationBouees3.size() + 1;
        recuperationBouees3.add(new Manipulation("Ramassage bouée 5 - Lever", ActionFileBinder.ActionFile.A2020_PMI_SORTIR_LEVER_BRAS_GAUCHE.ordinal(), Tache.Mirror.SPECIFIC));
        recuperationBouees3_3000.add(new Manipulation("Ramassage bouée 5 - Lever", ActionFileBinder.ActionFile.A2020_PMI_SORTIR_LEVER_BRAS_DROIT.ordinal(), Tache.Mirror.SPECIFIC), mirrorId);
        ...
        recuperationBouees6.add(new Manipulation("Ramassage bouée 6 - Pompe", ActionFileBinder.ActionFile.A2020_PMI_ATTRAPER_BRAS_DROIT.ordinal(), Tache.Mirror.SPECIFIC));
        recuperationBouees6_3000.add(new Manipulation("Ramassage bouée 6 - Pompe", ActionFileBinder.ActionFile.A2020_PMI_ATTRAPER_BRAS_GAUCHE.ordinal(), Tache.Mirror.SPECIFIC), mirrorId);
        mirrorId = recuperationBouees6.size() + 1;
        recuperationBouees6.add(new Manipulation("Ramassage bouée 6 - Poser", ActionFileBinder.ActionFile.A2020_PMI_POSER_BRAS_DROIT.ordinal(), Tache.Mirror.SPECIFIC));
        recuperationBouees6_3000.add(new Manipulation("Ramassage bouée 6 - Poser", ActionFileBinder.ActionFile.A2020_PMI_POSER_BRAS_GAUCHE.ordinal(), Tache.Mirror.SPECIFIC), mirrorId);
        mirrorId = recuperationBouees6.size() + 1;
        recuperationBouees6.add(new Manipulation("Ramassage bouée 6 - Lever", ActionFileBinder.ActionFile.A2020_PMI_SORTIR_LEVER_BRAS_DROIT.ordinal(), Tache.Mirror.SPECIFIC));
        recuperationBouees6_3000.add(new Manipulation("Ramassage bouée 6 - Lever", ActionFileBinder.ActionFile.A2020_PMI_SORTIR_LEVER_BRAS_GAUCHE.ordinal(), Tache.Mirror.SPECIFIC), mirrorId);
        ...
        petitPort.add(new Manipulation("Largage bouée 5 - Pompe", ActionFileBinder.ActionFile.A2020_PMI_LACHER_BRAS_DROIT.ordinal()));
        petitPort.add(new Manipulation("Largage bouée 6 - Pompe", ActionFileBinder.ActionFile.A2020_PMI_LACHER_BRAS_GAUCHE.ordinal()));
        ...
        petitPortBis.add(new Manipulation("Ramassage bouée 10 - Pompe", ActionFileBinder.ActionFile.A2020_PMI_ATTRAPER_BRAS_DROIT.ordinal(), Tache.Mirror.SPECIFIC));
        petitPortBis_3000.add(new Manipulation("Ramassage bouée 10 - Pompe", ActionFileBinder.ActionFile.A2020_PMI_ATTRAPER_BRAS_GAUCHE.ordinal(), Tache.Mirror.SPECIFIC), mirrorId);
        mirrorId = petitPortBis.size() + 1;
        petitPortBis.add(new Manipulation("Ramassage bouée 10 - Poser", ActionFileBinder.ActionFile.A2020_PMI_POSER_BRAS_DROIT.ordinal(), Tache.Mirror.SPECIFIC));
        petitPortBis_3000.add(new Manipulation("Ramassage bouée 10 - Poser", ActionFileBinder.ActionFile.A2020_PMI_POSER_BRAS_GAUCHE.ordinal(), Tache.Mirror.SPECIFIC), mirrorId);
        mirrorId = petitPortBis.size() + 1;
        petitPortBis.add(new Manipulation("Ramassage bouée 10 - Lever", ActionFileBinder.ActionFile.A2020_PMI_SORTIR_LEVER_BRAS_DROIT.ordinal(), Tache.Mirror.SPECIFIC));
        petitPortBis_3000.add(new Manipulation("Ramassage bouée 10 - Lever", ActionFileBinder.ActionFile.A2020_PMI_SORTIR_LEVER_BRAS_GAUCHE.ordinal(), Tache.Mirror.SPECIFIC), mirrorId);
        ...
        mirrorId = petitPortBis.size() + 1;
        petitPortBis.add(new Manipulation("Ramassage bouée 9 - Pompe", ActionFileBinder.ActionFile.A2020_PMI_ATTRAPER_BRAS_GAUCHE.ordinal(), Tache.Mirror.SPECIFIC));
        petitPortBis_3000.add(new Manipulation("Ramassage bouée 9 - Pompe", ActionFileBinder.ActionFile.A2020_PMI_ATTRAPER_BRAS_DROIT.ordinal(), Tache.Mirror.SPECIFIC), mirrorId);
        mirrorId = petitPortBis.size() + 1;
        petitPortBis.add(new Manipulation("Ramassage bouée 9 - Poser", ActionFileBinder.ActionFile.A2020_PMI_POSER_BRAS_GAUCHE.ordinal(), Tache.Mirror.SPECIFIC));
        petitPortBis_3000.add(new Manipulation("Ramassage bouée 9 - Poser", ActionFileBinder.ActionFile.A2020_PMI_POSER_BRAS_DROIT.ordinal(), Tache.Mirror.SPECIFIC), mirrorId);
        mirrorId = petitPortBis.size() + 1;
        petitPortBis.add(new Manipulation("Ramassage bouée 9 - Lever", ActionFileBinder.ActionFile.A2020_PMI_SORTIR_LEVER_BRAS_GAUCHE.ordinal(), Tache.Mirror.SPECIFIC));
        petitPortBis_3000.add(new Manipulation("Ramassage bouée 9 - Lever", ActionFileBinder.ActionFile.A2020_PMI_SORTIR_LEVER_BRAS_DROIT.ordinal(), Tache.Mirror.SPECIFIC), mirrorId);
        ...
        petitPortBis.add(new Manipulation("Largage bouée 9 - Pompe", ActionFileBinder.ActionFile.A2020_PMI_LACHER_BRAS_DROIT.ordinal()));
        petitPortBis.add(new Manipulation("Largage bouée 10 - Pompe", ActionFileBinder.ActionFile.A2020_PMI_LACHER_BRAS_GAUCHE.ordinal()));
