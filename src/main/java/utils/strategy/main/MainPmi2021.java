...
public class MainPmi2021 {
    ...
    public static void main(String... arg) throws Exception {
        ...
        recuperationBouees1_2.add(new GoTo("Mise en position bouée 1", 600, 250));
        recuperationBouees1_2.add(new Face("Alignement bouée 1", 0, 250));
        ...
        recuperationBouees1_2.add(new GoTo("Mise en position récupération bouée 1", 516, 250));
        ...
        recuperationBouees1_2.add(new GoTo("Mise en position bouée 2", 900, 250));
        recuperationBouees1_2.add(new Face("Alignement bouée 2", 2000, 250));
        mirrorId = recuperationBouees1_2.size() + 1;
        ...
        recuperationBouees1_2.add(new GoTo("Mise en position récupération bouée 2", 1084, 250));
        mirrorId = recuperationBouees1_2.size() + 1;
        ...
        recuperationBouees1_2.add(new GoToBack("Mise en position largage bouée 1", 995, 250));
        mirrorId = recuperationBouees1_2.size() + 1;
        recuperationBouees1_2.add(new Manipulation("Largage bouée 1 - Poser", ActionFileBinder.ActionFile.PMI_POSER_BRAS_DROIT.ordinal(), Tache.Mirror.SPECIFIC));
        recuperationBouees1_2_3000.add(new Manipulation("Largage bouée 1 - Poser", ActionFileBinder.ActionFile.PMI_POSER_BRAS_GAUCHE.ordinal(), Tache.Mirror.SPECIFIC), mirrorId);
        mirrorId = recuperationBouees1_2.size() + 1;
        ...
        mirrorId = recuperationBouees1_2.size() + 1;
        recuperationBouees1_2.add(new Manipulation("Largage bouée 1 - Lever", ActionFileBinder.ActionFile.PMI_SORTIR_LEVER_BRAS_DROIT.ordinal(), Tache.Mirror.SPECIFIC));
        recuperationBouees1_2_3000.add(new Manipulation("Largage bouée 1 - Lever", ActionFileBinder.ActionFile.PMI_SORTIR_LEVER_BRAS_GAUCHE.ordinal(), Tache.Mirror.SPECIFIC), mirrorId);
        recuperationBouees1_2.add(new Go("Retour au centre", -300));
        recuperationBouees1_2.add(new DeleteZone("Suppression zone bouée 2", "bouee2"));
        recuperationBouees1_2.add(new GoTo("Mise en position largage bouée 2", 605, 250));
        mirrorId = recuperationBouees1_2.size() + 1;
        recuperationBouees1_2.add(new Manipulation("Largage bouée 2 - Poser", ActionFileBinder.ActionFile.PMI_POSER_BRAS_GAUCHE.ordinal(), Tache.Mirror.SPECIFIC));
        recuperationBouees1_2_3000.add(new Manipulation("Largage bouée 2 - Poser", ActionFileBinder.ActionFile.PMI_POSER_BRAS_DROIT.ordinal(), Tache.Mirror.SPECIFIC), mirrorId);
        mirrorId = recuperationBouees1_2.size() + 1;
        ...
        mirrorId = recuperationBouees1_2.size() + 1;
        recuperationBouees1_2.add(new Manipulation("Largage bouée 2 - Lever", ActionFileBinder.ActionFile.PMI_SORTIR_LEVER_BRAS_GAUCHE.ordinal(), Tache.Mirror.SPECIFIC));
        recuperationBouees1_2_3000.add(new Manipulation("Largage bouée 2 - Lever", ActionFileBinder.ActionFile.PMI_SORTIR_LEVER_BRAS_DROIT.ordinal(), Tache.Mirror.SPECIFIC), mirrorId);
        recuperationBouees1_2.add(new GoToBack("Retour au centre", 750, 250));
        ...
        recuperationBouees4.add(new SetSpeed("Vitesse réduite", 70));
        recuperationBouees4.add(new GoToBack("Marquage bouée 4", 1090, 225));
        ...
        recuperationBouees3.add(new SetSpeed("Vitesse réduite", 70));
        recuperationBouees3.add(new GoToBack("Marquage bouée 3", 520, 225));
        ...
        recuperationBouees5.add(new GoTo("Mise en position bouée 5", 250, 720));
        recuperationBouees5.add(new Face("Alignement bouée 5", 0, 720));
        recuperationBouees5.add(new GoTo("Mise en position ramassage bouée 5", 216, 720));
        mirrorId = recuperationBouees1_2.size() + 1;
        ...
        recuperationBouees6.add(new GoToAstar("Mise en position bouée 6", 350, 670));
        recuperationBouees6.add(new GoTo("Mise en position bouée 6", 350, 800));
        recuperationBouees6.add(new Face("Alignement bouée 6", 350, 3000));
        recuperationBouees6.add(new GoTo("Mise en position ramassage bouée 6", 350, 840));
        mirrorId = recuperationBouees1_2.size() + 1;
        ...
        petitPort.add(new GoTo("Placement largage bouée 5 et 6", 1800, 1800));
        petitPort.add(new Manipulation("Largage bouée 5 - Poser", ActionFileBinder.ActionFile.PMI_POSER_BRAS_DROIT.ordinal()));
        petitPort.add(new Manipulation("Largage bouée 6 - Poser", ActionFileBinder.ActionFile.PMI_POSER_BRAS_GAUCHE.ordinal()));
        ...
        petitPort.add(new Manipulation("Largage bouée 5 - Lever", ActionFileBinder.ActionFile.PMI_SORTIR_LEVER_BRAS_DROIT.ordinal()));
        petitPort.add(new Manipulation("Largage bouée 6 - Lever", ActionFileBinder.ActionFile.PMI_SORTIR_LEVER_BRAS_GAUCHE.ordinal()));
...
//        strat.couleur0.add(startBoussole.couleur0.get(1)); // Sud
        ...
        try {
            ...
            Position startPoint = new Position(1020, 250, Math.PI);
