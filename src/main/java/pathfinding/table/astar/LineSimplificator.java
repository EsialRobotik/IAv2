 ...
 *
 */
public class LineSimplificator {
    /**
    ...
    public static List<Point> getSimpleLines(Collection<Point> chemin) {
        ...
        if(!chemin.isEmpty()) {
            ...
            Point.DIRECTION direction = Point.DIRECTION.NULL;
            ...
            for(Point courant : chemin) {
                ...
                if(precedent == null) {
                ...
                } else if(direction == Point.DIRECTION.NULL) {
                    ...
                    Point.DIRECTION newDirection = precedent.getDirectionToGoTo(courant);
