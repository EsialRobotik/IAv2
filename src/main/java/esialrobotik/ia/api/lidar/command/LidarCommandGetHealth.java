...
import esialrobotik.ia.api.lidar.command.exception.LidarCommandNotFinishedException;
import esialrobotik.ia.api.lidar.command.response.LidarResponseHealth;
import esialrobotik.ia.api.lidar.command.response.LidarResponseHealth.HEALTH;
