...
public class MainSerie2023 {
    ...
    public static void main(String... arg) throws Exception {
        ...
        generateJaune2(objectifsCouleur0, objectifsCouleur3000);
        generateAssiette4(objectifsCouleur0, objectifsCouleur3000);
        generateAssiette3(objectifsCouleur0, objectifsCouleur3000);
        generateRouesPlats(objectifsCouleur0, objectifsCouleur3000);
    ...
    private static void generateJaune2(List<Objectif> objectifsCouleur0, List<Objectif> objectifsCouleur3000) {
...
//        );
        ...
        recuperationGateauJaune2.add(
            new GoToBack("Prise jaune 2", 2460, 1775)
        );
        recuperationGateauJaune2.add(
    ...
    private static void generateAssiette3(List<Objectif> objectifsCouleur0, List<Objectif> objectifsCouleur3000) {
        ...
        deposeGateauxAssiette3.add(
            new GoTo("Assiette 3 - Position largage 1", 1100, 1700)
        );
        deposeGateauxAssiette3.add(
        ...
        deposeGateauxAssiette3.add(
            new GoToBack("Assiette 3 - Position largage 2", 1100, 1550)
        );
        deposeGateauxAssiette3.add(
        ...
        deposeGateauxAssiette3.add(
            new GoToBack("Assiette 3 - Position largage 3", 1100, 1400)
        );
        deposeGateauxAssiette3.add(
        ...
        deposeGateauxAssiette3.add(
            new GoToBack("Libération assiette 3", 1100, 1300)
        );
        deposeGateauxAssiette3.add(
    ...
    private static void generateAssiette4(List<Objectif> objectifsCouleur0, List<Objectif> objectifsCouleur3000) {
        ...
        deposeGateauxAssiette4.add(
            new GoTo("Assiette 4 - Position largage 1", 1750, 300)
        );
        deposeGateauxAssiette4.add(
        ...
        deposeGateauxAssiette4.add(
            new GoToBack("Assiette 4 - Position largage 2", 1750, 450)
        );
        deposeGateauxAssiette4.add(
        ...
        deposeGateauxAssiette4.add(
            new GoToBack("Assiette 4 - Position largage 3", 1750, 600)
        );
        deposeGateauxAssiette4.add(
        ...
        deposeGateauxAssiette4.add(
            new GoToBack("Libération assiette 4", 1750, 750)
        );
        deposeGateauxAssiette4.add(
            new GoTo("Libération assiette 4", 1600, 750)
        );
    ...
    private static void generateRouesPlats(List<Objectif> objectifsCouleur0, List<Objectif> objectifsCouleur3000) {
        ...
        finirPlat1.add(
            new GoToAstar("Go attente assiette 1", 2300, 1500)
        );
        finirPlat1.add(
            new WaitChrono("Wait 90s", 90)
        );
        finirPlat1.add(
            new GoTo("Go assiette 1", 2450, 1500)
        );
